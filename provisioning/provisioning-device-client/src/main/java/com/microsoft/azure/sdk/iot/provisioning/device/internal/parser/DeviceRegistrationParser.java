...
public class DeviceRegistrationParser
{
     ...
     * @param registrationId Registration Id to be sent to the service. Cannot be a {@code null} value.
     ...
     * @param registrationId Registration Id to be sent to the service. Cannot be a {@code null} value.
     * @param endorsementKey endorsement key to be sent to the service. Cannot be a {@code null} value.
     * @param storageRootKey Storage Root Key to be sent to the service. Cannot be a {@code null} value.
